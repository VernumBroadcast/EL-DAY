        ...
        <div style="text-align: center; max-width: 600px; position: relative;">
            ...
            <div style="background: white; padding: 40px 30px; border-radius: 25px; box-shadow: 0 20px 60px rgba(255,107,157,0.4); border: 5px solid #ff6b9d;">
                ...
                <div style="margin: 25px 0;">
                    <img src="images/hector.png" alt="Hector the Cat" style="max-width: 100%; max-height: 400px; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); object-fit: contain;" onerror="this.onerror=null; this.src='images/hector2.png';">
                </div>
